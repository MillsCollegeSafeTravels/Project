...
public class CrimeDbAdapter {
     ...
     */
    private static final String CRIMES_CREATE = "CREATE TABLE crimes (" + ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + TYPE + " TEXT NOT NULL, " + DESCRIPTION
            + " TEXT, " + DATE + " TEXT NOT NULL, " + LATITUDE + " DOUBLE NOT NULL, " + LONGITUDE
            + " DOUBLE NOT NULL);";
    ...
    /**
     * Add crime using the type and count provided. If the note is successfully
     ...
     * @param latitude
     *            the latitude of the crime
     * @param longus
     *            the longitude of the crime
     * @return rowId or -1 if failed
     */
    public long createCrime(String type, String description, String date, double latitude,
            double longitude) {
     ...
     * 
     * @param type
     *            type of the crimes to count
     * @return int count of crimes
     */
    /*
     * public Cursor countByType(String type) { String queryCount =
     * "select count(*) from " + DATABASE_TABLE + " where " + TYPE + "=" + type
     * + ";"; return mDb.rawQuery(queryCount, null); }
     */

    /**
     * Return a Cursor over the list of all crimes in the database with all
     * information
     * 
     * @return Cursor over all crimes
     */
    public Cursor fetchAllInfo() {
        return mDb.query(DATABASE_TABLE, new String[] { ID, TYPE, DESCRIPTION, DATE, LATITUDE,
                LONGITUDE }, null, null, null, null, null);
    }// fetchAllCrimes

    /**
     * Return a Cursor over the list of all crimes in the database with only id
     * and type information
     * 
     * @return Cursor over all crimes
     */
    public Cursor fetchAllType() {
        return mDb.query(DATABASE_TABLE, new String[] { ID, TYPE }, null, null, null, null, null);
    }// fetchAllCrimesType

    /**
     * Return a Cursor over the list of all crimes in the database with only id,
     * type,latitude, and longitude information
     * 
     * @return Cursor over all crimes
     */
     ...
     * 
     * @param type
     *            type of crime to retrieve
     * @return Cursor positioned to matching crime, if found
     * @throws SQLException
     *             if crime could not be found/retrieved
     */
    public Cursor fetchByType(String type) throws SQLException {
        Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] { ID, DESCRIPTION, DATE,
                LATITUDE, LONGITUDE }, TYPE + "=" + type, null, null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
        return mCursor;
     ...
     * 
     * @param rowId
     *            id of crime to update
     * @param title
     *            value to set crime type to
     * @param description
     *            value to set crime description to
     * @param date
     *            value to set crime date to
     * @param latitude
     *            value to set crime latitude to
     * @param longitude
     *            value to set crime longitude to
     * @return true if the crime was successfully updated, false otherwise
     */
    public boolean updateCrime(long rowId, String type, String description, String date,
